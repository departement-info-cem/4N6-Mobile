...
## libs.version.toml
    ...
    Il va falloir ajouter les versions de retrofit et okhttp que vous voulez utiliser dans la section [version] et les alias de dépendance dans la section [libraries].

    <GHCode
              repo="4N6-Mobile"
              filePath="code/ComposeRetrofitBase/gradle/libs.versions.toml"
              startLine="11"
              endLine="12"
              />
