...
Nous allons voir comment gérer plusieurs langues dans une application Android.


Le code de cette recette est disponible [ici](https://github.com/departement-info-cem/4N6-Applis-Mobile/tree/main/code/RecetteRecyclerViewString).
