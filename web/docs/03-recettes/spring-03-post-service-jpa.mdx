...
On va montrer comment implémenter un CRUD en Spring Boot avec JPA et une couche de service.
...
## Repository
        ...
        1. ajouter un truc en validant qu'il n'y a pas déjà un truc avec la même chose
...
## Classe de service
    ...
    - l'objet dont le service dépend est injecté par Spring au lieu d'avoir à faire un **new TrucRepo**
...
## Tests
                  ...
                  ![chemin de application-test.properties est src test resources application-test.properties](/img/application-test.png)

                  </Column>
                  <Column>
                  Le contenu du fichier src/test/resources/application-test.properties est le suivant :
                  <GHCode
                                        repo="4N6-Mobile"
