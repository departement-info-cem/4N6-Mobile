...
<Tabs queryString="recette-activite">
    ...
    <TabItem value="Exemple avec boucle" label="Exemple avec boucle">
    ...
    <TabItem value="Exemple avec une fonction" label="Exemple avec une fonction">
    ...
    <TabItem value="valider-ta-trace" label="Valider ta trace">
    ...
    <TabItem value="Procédure pour faire un exercice" label="Procédure pour faire un exercice">
        ...
        7. Crée-toi un projet kotlin ou Android pour [valider ta trace](?recette-activite=valider-ta-trace) en utilisant le débogueur.
