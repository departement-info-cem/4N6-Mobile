...
Le code *markdown* de ce tableau est disponible [ici](https://github.com/departement-info-cem/4N6-Mobile/tree/main/code/Trace/trace.md).
...
S'il y a des fonctions dans le code, on doit ajouter la pile d'appels pour indiquer quelles fonctions
