...
<Tabs queryString="recette-activite">
    ...
    <TabItem value="Requête client-serveur" label="Requête client-serveur">

    On veut faire la trace d'exécution lorsqu'un ouvre l'application client, en assumant que le serveur roule.
