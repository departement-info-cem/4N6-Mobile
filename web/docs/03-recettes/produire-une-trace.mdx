    ...
    On veut faire la trace d'exécution lorsqu'on ouvre l'application client, en assumant que le serveur roule et que tout se passe bien.
        ...
        <Row>
            ...
            <Column>
                ...
                |```retrofit.service.plus100(42).enqueue(object : retrofit2.Callback<Int> {```  |appelle la méthode plus100 avec 42 -> nombre et lance la requête http://10.0.2.2:8080/plus100/42 en asynchrone|onCreate|
                |```return nombre + 100;```|retourne 142 et renvoie la réponse HTTP avec "142" comme corps et le code 200 Ok|plus100|
