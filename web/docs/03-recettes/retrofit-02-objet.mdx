...
## debug
    ...
    ![un point d'arrêt sur le call.enqueue, un point d'arrêt sur la première ligne du onResponse, un point d'arrêt sur la première ligne du onFailure](retrofit-2.png)
