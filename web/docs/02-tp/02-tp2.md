...
- &#8203;<Highlight color="tip">2 points</Highlight> **`/id/connexion`** en **POST**, classes de transfert sont SigninRequest et SigninResponse.
- &#8203;<Highlight color="tip">2 points</Highlight> **`/id/inscription`** en **POST**, classes de transfert sont SignupRequest et SigninResponse.
...
- &#8203;<Highlight color="tip">1 point</Highlight> **`/tache/ajout`** en **POST**, envoie un AddTaskRequest et ne reçoit rien.
- &#8203;<Highlight color="tip">2 points</Highlight> **`/tache/accueil`** en **GET**, n'envoie rien (identifié grâce à ton cookie), reçoit une liste de HomeItemResponse.
...
- &#8203;<Highlight color="tip">1 point</Highlight> **`/tache/detail/{id}`** en **GET**, envoie l'id de la tâche et reçoit un TaskDetailResponse. Permet la récupération du détail de la tâche.
