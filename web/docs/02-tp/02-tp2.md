...
- inclure jitpack dans votre projet
...
- &#8203;<Highlight color="tip">2 points</Highlight> **`/id/connexion`** en **POST**, classes de transfert sont RequeteConnexion et ReponseConnexion.
- &#8203;<Highlight color="tip">2 points</Highlight> **`/id/inscription`** en **POST**, classes de transfert sont RequeteInscription et ReponseConnexion.

La classe de réponse est la même pour les 2 car une inscription effectue également la connexion, il s'agit de ReponseConnexion.
...
&#8203;<Highlight color="tip">2 points</Highlight> Suite à inscription, votre tiroir doit afficher le nom d'utilisateur récupéré à la connexion. Nous vous recommandons de le stocker dans un singleton pour y avoir accès de tous les écrans.
...
- &#8203;<Highlight color="tip">1 point</Highlight> **`/tache/ajout`** en **POST**, envoie un RequeteAjoutTache et ne reçoit rien.
- &#8203;<Highlight color="tip">2 points</Highlight> **`/tache/accueil`** en **GET**, n'envoie rien (identifié grâce à ton cookie), reçoit une liste de ReponseAccueilItem.
...
- &#8203;<Highlight color="tip">1 point</Highlight> **`/tache/detail/{id}`** en **GET**, envoie l'id de la tâche et reçoit un ReponseDetailTache. Permet la récupération du détail de la tâche.
- &#8203;<Highlight color="tip">1 point</Highlight> **`/tache/progres/{idTache}/{valeur}`** en **GET**, envoie l'id de la tâche et la nouvelle valeur d'avancement entre 0 et 100. Permet de changer le pourcentage d'avancement.
...
La déconnexion se fait à partir du tiroir de navigation. Elle doit être fonctionnelle dans tous les écrans avec le tiroir.

- &#8203;<Highlight color="tip">1 point</Highlight> **`/id/deconnexion`** en **POST**.
- &#8203;<Highlight color="tip">1 point</Highlight> La déconnexion fonctionne dans tous les écrans avec tiroir de navigation.
