...
Maintenant que vous connaissez bien la structure d'un serveur Spring Boot, vous êtes prêts à implémenter la suppression de tâche dans le serveur dans le cadre du TP3.
